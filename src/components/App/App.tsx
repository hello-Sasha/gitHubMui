...
export const App: FC = () => {
  ...
  return (
    <div style={{
      ...
      display: "flex"}}>
      <HashRouter>
        {/*<Header users={initialUsers} /> //preusers*/}
        <Routes>
          <Route path="/" element={<Layout preusers={preusers}/>}>
            <Route path="/users/:login" element={<UserProfilePage />} />
            <Route path="/search/:login" element={<UsersSearchPage />} />
            <Route
              path="/whatever"
              element={
            ...
            />
            <Route path="/" element={<UsersPage preusers={preusers} />} />
          </Route>
        </Routes>
      </HashRouter>
    </div>
